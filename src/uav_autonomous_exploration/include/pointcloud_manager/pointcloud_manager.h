...
public:
  ...
  void UpdateCoveredCloudPoints_uav(int cloud_index, int point_index);
  void Set_invalidate_viewpoint_and_point_in_covered_boxes(bool flag)
  {
    invalidate_viewpoint_and_point_in_covered_boxes = flag;
  }
private:
