...
public:
  ...
  void Addcantidate_frontier_viewpoint_indices_(int viewpoint_ind)
  {
    cantidate_frontier_viewpoint_Hier_indices_.push_back(viewpoint_ind);
  }
  void Addboundary_viewpoint_indices_(int viewpoint_ind)
  {
    boundary_viewpoint_Hier_indices_.push_back(viewpoint_ind);
  }
  void Add_frontier_viewpoint_size_indices_()
  {
    frontier_viewpoint_num_ += 1;
  }
  ...
  void Clearcantidate_frontier_viewpoint_indices_()
  {
    cantidate_frontier_viewpoint_Hier_indices_.clear();
  }
  void Clearboundary_viewpoint_indices_()
  {
    boundary_viewpoint_Hier_indices_.clear();
  }
  void Clearfrontier_viewpoint_size()
  {
    frontier_viewpoint_num_ = 0;
  }
  ...
  std::vector<int> Getcantidate_frontier_viewpoint_indices_()
  {
    return cantidate_frontier_viewpoint_Hier_indices_;
  }
  std::vector<int> Getboundary_viewpoint_indices_()
  {
    return boundary_viewpoint_Hier_indices_;
  }
  int Getfrontier_viewpoint_size_()
  {
    return frontier_viewpoint_num_;
  }
  ...
  void Setconnection_point_geo(geometry_msgs::msg::Point point)
  {
    connection_point_geo = point;
  }
  geometry_msgs::msg::Point Getconnection_point_geo()
  {
    return connection_point_geo;
  }
...
private:
  ...
  std::vector<int> cantidate_frontier_viewpoint_Hier_indices_;
  std::vector<int> boundary_viewpoint_Hier_indices_;

  int frontier_viewpoint_num_;
...
{
public:
  explicit GridWorld(std::shared_ptr<rclcpp::Node>& nh);
  ...
  void Addcantidate_frontier_ViewPointToCell(int cell_ind, int viewpoint_ind);
  void Addboundary_ViewPointToCell(int cell_ind, int viewpoint_ind);
  void Setfrontier_ViewPoint_sizeToCell(int cell_ind);
  ...
  void UpdateCellStatus(const std::unique_ptr<planning_env_ns::PlanningEnv>& planning_env, const std::unique_ptr<keypose_graph_ns::KeyposeGraph>& keypose_graph, const std::shared_ptr<uav_viewpoint_manager_ns::ViewPointManager>& uav_viewpoint_manager, std::vector<int>& global_cell_covered_marker_vec);
  exploration_path_ns::ExplorationPath
  SolveGlobalTSP(const std::shared_ptr<uav_viewpoint_manager_ns::ViewPointManager>& uav_viewpoint_manager, std::vector<int>& global_cell_covered_marker_vec,
  ...
  void AddPathsInBetweenCells(const std::shared_ptr<uav_viewpoint_manager_ns::ViewPointManager>& uav_viewpoint_manager,
  ...
  std::vector<int>  global_cell_covered_marker_vec_;
  std::unique_ptr<grid_ns::Grid<Cell>> & get_subspaces_()
  {
    return subspaces_;
  }
  std::unique_ptr<pointcloud_utils_ns::PCLCloud<pcl::PointXYZI>> global_viewpoint_cloud;
private:
  int kRowNum;
  int kColNum;
  int kLevelNum;
  ...
  bool Estime_any_Frontier_viewpoint_asexploring;
  ...
  // std::vector<int> neighbor_cell_indices_3_3_3_;
  ...
  geometry_msgs::msg::Point global_path_robot_position;
};
}  // namespace grid_world_ns
