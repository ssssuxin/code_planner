...
#ifndef SENSOR_COVERAGE_PLANNER_UAV_KEYPOSE_GRAPH_H
#define SENSOR_COVERAGE_PLANNER_UAV_KEYPOSE_GRAPH_H
...
namespace uav_keypose_graph_ns
{
struct KeyposeNode;
class KeyposeGraph;
...
struct uav_keypose_graph_ns::KeyposeNode
{
...
class uav_keypose_graph_ns::KeyposeGraph
{
private:
...
#endif  // SENSOR_COVERAGE_PLANNER_UAV_KEYPOSE_GRAPH_H
