...
public:
  ...
  void SetinitiaPosition(const geometry_msgs::msg::Point& position)//给frontier viewpoint用的
  {
    lidar_model_.setinitiaPosition(position);
  }
  double GetX() const
  {
  ...
  geometry_msgs::msg::Point GetintiPosition() const
  {
    return lidar_model_.getinitiaPosition();
  }
  void ResetCoverage();
  void Reset();
  ...
  void Set_connected_to_graph(bool connected_to_graph)
  {
    connected_to_graph_ = connected_to_graph;
  }
  bool connectedtograph()const
  {
    return connected_to_graph_;
  }

  void Set_first_added(bool first_added)
  {
    first_added_ = first_added;
  }
  bool first_added()const
  {
    return first_added_;
  }

  int& Get_robot_near_count()
  {
    return robot_near_count;
  }

  void Set_connted_com_viewpoint_Hier_ind(int conntedcomviewpointind_)
  {
    connted_com_viewpoint_ind = conntedcomviewpointind_;
  }
  int conntedcomviewpointHierind()const
  {
    return connted_com_viewpoint_ind;
  }


  void Set_station_ind(std::vector<int> keypose_station_ind_vec)
  {
    keypose_station_ind_vec_ = keypose_station_ind_vec;
  }
  std::vector<int>& Get_keypose_station_ind()
  {
    return keypose_station_ind_vec_;
  }


  void SetIn_real_Collision(bool in_real_collision)
  {
    in_real_collision_ = in_real_collision;
  }
  bool In_real_Collision() const
  {
    return in_real_collision_;
  }
  ...
  void Setnear_free_position_in_occupancy(std::vector<Eigen::Vector3d> nearfreepositioninoccupancy)
  {
    near_free_position_in_occupancy = nearfreepositioninoccupancy;
  }
  std::vector<Eigen::Vector3d>& Getnear_free_position_in_occupancy() 
  {
    return near_free_position_in_occupancy;
  }
  ...
  void Setin_covered_box(bool inbox)
  {
    in_covered_box = inbox;
  }
  bool In_covered_box() const
  {
    return in_covered_box;
  }
  ...
  bool Get_in_collision_()
  {
    return in_collision_;
  }
  bool Get_in_real_collision_()
  {
    return in_real_collision_;
  }
private:
  ...
  int connted_com_viewpoint_ind;

  int robot_near_count;

  bool connected_to_graph_;

  bool first_added_;

  bool in_real_collision_;
  ...
  std::vector<int> keypose_station_ind_vec_;

  std::vector<Eigen::Vector3d> near_free_position_in_occupancy;
};
}  // namespace viewpoint_ns
