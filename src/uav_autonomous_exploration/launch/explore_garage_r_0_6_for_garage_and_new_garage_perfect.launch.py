...
def generate_launch_description():
    ...
    uav_planner_node = Node(
        ...
        parameters=[             
                    ...
                    {"viewpoint_manager/resolution_x":1.4},
                    {"viewpoint_manager/resolution_y":1.4},
                    {"viewpoint_manager/resolution_z":0.5},
                    ...
                    {"viewpoint_manager/min_box_size_z":5},
                    ...
                    {"kMinAddFrontierPointNum":10},#候选点包含 frontier 的最低数量（local 和 grid world）
