...
def generate_launch_description():
    ...
    uav_planner_node = Node(
        ...
        parameters=[             
                    ...
                    {"kExtendWayPointDistanceBig":1.15},
                    {"kExtendWayPointDistanceSmall":1.15},
                    ...
                    {"valid_frontier_point_num_thred":400},#100以内的簇才有资格让frontier viewpoint来操作
                    ...
                    {"viewpoint_manager/min_box_size_x":4},
                    {"viewpoint_manager/min_box_size_y":4},
                    ...
                    {"para_visited_radius":10.5},#标记访问了半径
                    {"least_visible_unknown_num":100},#覆盖到未标绿点小于这个数 则使命结束
                    {"least_visible_free_num":11},
                    ...
                    {"kMinAddPointNumSmall":40},#候选点包含 墙面点 的最低数量（local 和 grid world）
                    ...
                    {"Estime_any_Frontier_viewpoint_asexploring":False},#只要是
                    # # Visualization
